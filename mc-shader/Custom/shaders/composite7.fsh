...
/* Bloom chain: tent-upsample colortex10 into colortex9 and add.
...
void main() {
    vec2 texelSize = 1.0 / (vec2(viewWidth, viewHeight) * 0.03125);

    vec4 upper   = upsampleTent(colortex10, texcoord, texelSize, 1.0);
