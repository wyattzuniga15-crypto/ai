...
| Structures | 30 | 4 (igloo, shipwreck, ruined portal, pillager outpost) from Mojang's own templates, on vanilla's spread and biome lists | – | 26 (villages and the rest need the jigsaw and code-built pieces) |
