...
| Structures | 30 | 5 (village ×5 types, igloo, shipwreck, ruined portal, pillager outpost) from Mojang's own templates, on vanilla's spread and biome lists, villages assembled through the jigsaw pools | – | 25 (mineshafts, strongholds, temples and the rest) |
