...
| Structures | 30 | 5 (village ×5 types, igloo with its ladder shaft and laboratory, shipwreck, ruined portal, pillager outpost) from Mojang's own templates, on vanilla's spread and biome lists, villages assembled through the jigsaw pools in the type their biome calls for, every chest filled from the table the template names, each chunk writing its own part of whatever reaches it | – | 25 (mineshafts, strongholds, temples and the rest) |
