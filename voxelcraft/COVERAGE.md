...
| Structures | 30 | 6 (village ×5 types, igloo with its ladder shaft and laboratory, shipwreck, ruined portal, pillager outpost, abandoned mineshaft) from Mojang's own templates, on vanilla's spread and biome lists, villages assembled through the jigsaw pools in the type their biome calls for, mineshafts walked out of vanilla's own pieces, every chest filled from the table the template names, each chunk writing its own part of whatever reaches it | – | 24 (strongholds, temples, monuments and the rest) |
