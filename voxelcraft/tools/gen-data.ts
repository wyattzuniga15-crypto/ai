...
function blockBehavior(b: MdBlock): string {
  ...
  if (CROPS.has(n)) return 'crop';
  if (CONTAINERS.has(n) || n.endsWith('shulker_box')) return 'container';
  if (WORKSTATIONS.has(n)) return 'workstation';
  if (REDSTONE.has(n) || n.endsWith('_rail')) return 'redstone';
  ...
  if (n.endsWith('_wall') && !n.endsWith('_wall_torch')) return 'wall';
  if (n.endsWith('_stairs')) return 'stairs';
  if (n.endsWith('_slab')) return 'slab';
  if (n.endsWith('_bed')) return 'bed';
  if (n.endsWith('_sign')) return 'sign';
  if (n.endsWith('_banner')) return 'banner';
  if (n.endsWith('_head') || n.endsWith('_skull')) return 'head';
  if (n.endsWith('_leaves')) return 'leaves';
  if (n.endsWith('_sapling') || n === 'bamboo_sapling') return 'sapling';
  if (n.endsWith('_carpet') || n === 'moss_carpet' || n === 'pale_moss_carpet') return 'carpet';
  if (n.endsWith('_glass_pane') || n === 'glass_pane' || n === 'iron_bars' || n.endsWith('_bars')) return 'pane';
  if (n.endsWith('_glass') || n === 'glass' || n === 'tinted_glass') return 'glass';
  if (n.endsWith('_torch') || n === 'torch') return 'torch';
  if (n.endsWith('_candle') || n === 'candle' || n.endsWith('_candle_cake') || n === 'candle_cake') return 'candle';
  if (n.endsWith('_concrete_powder') || FALLING.has(n)) return 'falling';
  if (n.endsWith('_log') || n.endsWith('_wood') || n.endsWith('_stem') && n.includes('crimson') || n.endsWith('_hyphae') || n === 'bamboo_block' || n === 'stripped_bamboo_block' || n.includes('stripped_')) return 'log';
  if (n.endsWith('_ore') || n === 'ancient_debris' || n === 'gilded_blackstone') return 'ore';
  if (n.endsWith('_coral') || n.endsWith('_coral_fan') || n.endsWith('_coral_wall_fan') || n.endsWith('_coral_block')) return 'coral';
  if (n === 'ladder' || n === 'vine' || n === 'scaffolding' || n.endsWith('_vines') || n.endsWith('_vines_plant')) return 'climbable';
  ...
  if (n === 'fire' || n === 'soul_fire') return 'fire';
  if (n === 'nether_portal' || n === 'end_portal' || n === 'end_gateway') return 'portal';
  if (n === 'bedrock' || n === 'barrier' || n === 'command_block' || n === 'structure_block' || n === 'jigsaw' || n === 'light' || n.endsWith('_command_block') || n === 'end_portal_frame' || n === 'reinforced_deepslate') return 'unbreakable';
  if (n === 'ice' || n === 'packed_ice' || n === 'blue_ice' || n === 'frosted_ice') return 'ice';
  if (b.material.includes('plant') || n.endsWith('_flower') || n.endsWith('_bush') || n === 'short_grass' || n === 'tall_grass' || n === 'fern' || n === 'large_fern' || n === 'dead_bush' || n.endsWith('_mushroom') || n.endsWith('_fungus') || n.endsWith('_roots') || n === 'nether_sprouts' || n === 'seagrass' || n === 'tall_seagrass' || n === 'lily_pad' || n === 'moss_carpet' || n === 'sea_pickle' || n === 'small_dripleaf' || n === 'big_dripleaf' || n === 'big_dripleaf_stem' || n === 'spore_blossom' || n === 'hanging_roots' || n === 'pink_petals' || n === 'wildflowers' || n === 'bush' || n === 'firefly_bush' || n === 'cactus_flower' || n === 'leaf_litter' || n === 'sunflower' || n === 'lilac' || n === 'rose_bush' || n === 'peony' || n === 'pitcher_plant' || n === 'torchflower' || n === 'glow_lichen' || n === 'sculk_vein' || n === 'dry_grass' || n === 'short_dry_grass' || n === 'tall_dry_grass') return 'plant';
